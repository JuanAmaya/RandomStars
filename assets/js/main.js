...
const legendary = ["Amber", "Crow", "Leon", "Meg", "Sandy", "Spike"];
const chromatic = [
  "Ash",
  "Belle",
  "Buzz",
...
function paginasCartas() {
  ...
  creacionCartas(
    ...
    "1-TrophyRoad",
    cartasBrawlers,
    "linear-gradient(#9dd7f5, #8bbed8)"
  );
  creacionCartas(
    rare,
    "2-Rare",
    cartasBrawlers,
    "linear-gradient(#52dd00, #40a803)"
  );
  creacionCartas(
    superRare,
    "3-SuperRare",
    cartasBrawlers,
    "linear-gradient(#3288fd, #1c4986)"
  );
  creacionCartas(
    epic,
    "4-Epic",
    cartasBrawlers,
    "linear-gradient(#ab19f1, #6e0f9b)"
  );
  creacionCartas(
    mythic,
    "5-Mythic",
    cartasBrawlers,
    "linear-gradient(#f40014, #6c0009)"
  );
  creacionCartas(
    legendary,
    "6-Legendary",
    cartasBrawlers,
    "linear-gradient(#fdf344, #807b27)"
  );
  creacionCartas(
    chromatic,
    "7-Chromatic",
...
function guardarBrawlers() {
  sessionStorage.setItem(
    "arregloCancelados",
    JSON.stringify(arregloCancelados)
  );
}
...
function guardarModos() {
  sessionStorage.setItem(
    "arregloModosCancelados",
    JSON.stringify(arregloModosCancelados)
  );
}
...
function cambiarFondo() {
  ...
  if (
    ...
    "linear-gradient(rgb(72, 22, 157), rgb(203, 109, 214))"
  ) {
    sessionStorage.setItem("colorFondo", "linear-gradient(#2b36a2, #528af9)");
    cuerpo.style.background = "linear-gradient(#2b36a2, #528af9)";
  } else {
    sessionStorage.setItem("colorFondo", "linear-gradient(#48169d, #cb6dd6)");
    cuerpo.style.background = "linear-gradient(#48169d, #cb6dd6)";
  }
...
//   loop: false,
//   autoplay: false,
//   path: "https://assets3.lottiefiles.com/packages/lf20_wgcqrpue.json",
// });
